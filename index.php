...
.modal-content {
    ...
    position: relative;
    z-index: 1001; /* Más alto que el fondo */
}

/* Consulta de medios para pantallas de 340px o menos */
...
.bienvenida {
    z-index: 1; /* Asegúrate de que sea menor que el modal */
...
line-height: 1;
   ...
   <header>
    ...
    <!-- Botón para abrir la ventana emergente -->
    <label for="modal-toggle" class="btn-open"><i class="fa-solid fa-cart-shopping"></i> (<?= array_sum(array_column($carrito, 'cantidad')) ?>)</label>
