...
.whatsapp-button {
    ...
    <header>
        ...
        <div class="main-nav">
            <nav class="nav-left">
                <a class="consultas" href="vista/consulBDtortasview.php">tortas</a>
                <a class="consultas" href="vista/consulBDmedidasview.php">medidas</a>
                <a class="consultas"href="vista/consulBDingreview.php">ingredientes</a>
            </nav>
            <div class="icons-container">
                <a href="perfiladmi.php"><i class="fa-solid fa-user"></i></a>
